...
- [AKS deployment change list](./docfiles/markdown/AKS_DEPLOYMENT_CHANGES.md) for the deployment-related updates behind the current remote AKS instructions.
...
.. toctree::
   ...
   docfiles/markdown/AKS_DEPLOYMENT_CHANGES
